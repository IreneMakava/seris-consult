...
const ScrollTop = () => {
  ...
  return (
    <Zoom in={true}>
      ...
      >
        <Fab size="small" aria-label="scroll back to top" sx={{ bgcolor: '#1F6E3F', color: 'white' }}>
          <KeyboardArrowUpIcon />
        </Fab>
      </Box>
    </Zoom>
...
const Footer = () => {
  return (
    <Box component="footer" sx={{ backgroundColor: '#1F6E3F', color: 'white', mt: 6, pt: 4 }}>
        ...
        <Grid container spacing={4} justifyContent="space-between">
          ...
          <Grid item xs={12} sm={4} md={3}>
            ...
            <Box>
              ...
              <Link href="https://serisfoundation.org" underline="none" color="inherit" display="block" mb={1}>Read More</Link>
            </Box>
          </Grid>
...
<Grid item xs={12} sm={5} md={4}>
  ...
  <Box display="flex" alignItems="center" mb={1}>
    ...
    <Typography variant="body2">
      P.O.Box 90258
      <br />
      Samora Avenue,Holland House 4th Floor
<br />
      Dsm - Tanzania
    </Typography>
  </Box>
  ...
  <Box display="flex" alignItems="center" mb={1}>
    <EmailIcon sx={{ mr: 1 }} />
    <Typography variant="body2">info@serisconsult.co.tz</Typography>
  </Box>

  <Box display="flex" alignItems="center">
    <PhoneIcon sx={{ mr: 1 }} />
    <Typography variant="body2">0787089937</Typography>
  </Box>
</Grid>
        ...
        <Box mt={4} borderTop={1} borderColor="gray" pt={3} pb={2} display="flex" justifyContent="space-between" flexWrap="wrap">
          <Typography variant="body2">
            © 2025 Copyright: 
            <Link href="https://serisconsult.co.tz" color="inherit" underline="none" sx={{ ml: 1 }}>
              Seris All Rights Reserved
            </Link>
          </Typography>
        </Box>
      </Container>
